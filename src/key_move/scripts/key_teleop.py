...
class SimpleKeyTeleop():
    ...
    def _publish(self):
        ...
        self._interface.write_line(4, 'Use arrow keys to move, q to exit.')
        self._interface.write_line(5, 'Key a to change to auto control mode')
        self._interface.write_line(6, 'Auto control: ' + str(self._auto_control))
        self._interface.refresh()
